...
const Loader: React.FC = () => {
    return <div className="">
        <svg viewBox="0 0 96 96" width="48" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <path
                ...
                fill="#646cff" fill-rule="evenodd" >
                <animate attributeName="fill" dur="0.5s" values="#646cff;#fff;#646cff" repeatCount="indefinite" />
            </path>
        </svg>
    </div>
}
